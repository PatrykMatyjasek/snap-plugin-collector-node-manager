...
func TestGetMetrics(t *testing.T) {
	Convey("Check GetMetricsTypes", t, func() {
		...
		Convey("Proper metrics should be returned", func() {
			...
			So(len(mts), ShouldEqual, 39)
			So(str.Contains(metricNames, "/intel/node_manager/*/cups/cpu_bandwith"), ShouldBeTrue)
			So(str.Contains(metricNames, "/intel/node_manager/*/cups/memory_bandwith"), ShouldBeTrue)
			So(str.Contains(metricNames, "/intel/node_manager/*/cups/io_bandwith"), ShouldBeTrue)
